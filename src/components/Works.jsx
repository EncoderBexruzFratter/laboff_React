            ...
            <section className="bg-white md:pt-[120px] py-[84px] md:pb-[190px]">
                <div className="max-w-[1206px]  relative mx-auto px-5">
                    ...
                    <div className="max-w-[960px] w-full mx-auto mb-8 ">
                            ...
                            <SwiperSlide>
                                <div className="w-full">
                                    <img
                                        src={work}
                                        alt=""
                                        className="object-cover w-full mb-[26px]"
                                    />
                        ...
                        text-[#000000CC] mb-6 md:mb-0"
                                    >
                                        В наличии более 5000 позиций. Для корректного подбора укажите
                                        марку авто, год выпуска и наличие{" "}
                                    </p>
                                    <div
                                        className="md:hidden flex items-center gap-4 font-medium text-sm  text-[#197FAF]">
                                          <img src={ruka} alt="" />
                                        Листайте влево
                                    </div>
                                </div>
